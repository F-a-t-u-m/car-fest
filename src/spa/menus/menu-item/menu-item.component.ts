...
import { Component, OnInit, Input, ElementRef, Renderer2, HostListener, HostBinding, ɵɵi18nApply } from '@angular/core';
import { Router, NavigationEnd } from '@angular/router';
import { visibilityPopup } from 'src/spa/services/animations';
