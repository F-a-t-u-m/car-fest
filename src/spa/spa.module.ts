...
@NgModule({
	...
	declarations: [SpaBodyComponent, SpaContentComponent, SpaHeaderComponent, SpaFooterComponent, IconBarComponent, ScreenLargeDirective, ScreenSmallDirective, MenuComponent, MenuItemComponent, PopupMenuComponent, SignInComponent, RegistrationComponent, DynamicFieldComponent, DynamicFormComponent, PanelComponent],
